...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/AlinallmoviesRequestUpdates"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/Alinallmovies")],
                    [InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/Alinallmoviesrequest"), InlineKeyboardButton("💎 𝙱𝙾𝚃𝚂 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 💎", url="https://t.me/FileStore_Bots_Updates")],
                    [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="@Alinallmovies_Request_Bot")]
                ]
            ),
