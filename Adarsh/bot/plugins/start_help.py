    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                return
        await m.reply_photo(
            photo="https://telegra.ph/file/bf712ef6e41ac7b00bb0d.jpg",
            caption="**ʜᴇʟʟᴏ...⚡\n\nɪᴀᴍ ᴀ sɪᴍᴘʟᴇ ᴛᴇʟᴇɢʀᴀᴍ ғɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ.**\n\n**ᴜsᴇ /help ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛsɪʟs\n\nsᴇɴᴅ ᴍᴇ ᴀɴʏ ᴠɪᴅᴇᴏ / ғɪʟᴇ ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀᴢ...**",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("♻️ 𝙱𝙾𝚃𝚂 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ♻️", url="https://t.me/FileStore_Bots_Updates"), InlineKeyboardButton("🥀 𝙾𝚆𝙽𝙴𝚁 🥀", url="https://t.me/thavarajtj")]
                ]
            ),
...
┃
┣⪼<b>ʙᴏᴛ ɴᴀᴍᴇ : <a href='http://t.me/FileToLink_4GB_UltraSpeedV3_Bot'>4𝗚𝗕 𝗙𝗜𝗟𝗘 𝗧𝗢 𝗟𝗜𝗡𝗞 𝗕𝗢𝗧</a></b>
┣⪼<b>ᴜᴘᴅᴀᴛᴇᴢ : <a href='https://t.me/kwicbotupdates'>𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘𝗦</a>
┣⪼<b>sᴇʀᴠᴇʀ : ʜᴇʀᴜᴋᴏ</b>
